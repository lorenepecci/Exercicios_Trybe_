...
const findMateria = (materiaMaior, materia) => ((materiaMaior.nota > materia.nota) ? materiaMaior : materia) ;
/* console.log(estudantes[1].materias.reduce(findMateria).name) */

const criarLista = estudantes.map((estudante) => ({
    name: estudante.nome,
    materia: estudante.materias.reduce(findMateria).name
